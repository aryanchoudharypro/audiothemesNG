...
class AudioThemesSettingsPanel(SettingsPanel):
    ...
    def makeSettings(self, settingsSizer):
        ...
        # Reverb Settings
        reverbStaticBox = wx.StaticBox(innerPanel, -1, _("Reverb Settings"))
        reverbSizer = wx.StaticBoxSizer(reverbStaticBox, wx.VERTICAL)

        self.enableReverbCheckbox = wx.CheckBox(innerPanel, -1, _("Enable Reverb"))
        reverbSizer.Add(self.enableReverbCheckbox, 0, wx.ALL, 5)

        self.roomSizeLabel = wx.StaticText(innerPanel, -1, _("Room Size:"))
        self.roomSizeSlider = wx.Slider(innerPanel, -1, minValue=0, maxValue=100, name=_("Room Size"))
        reverbSizer.AddMany([
            (self.roomSizeLabel, 0, wx.TOP | wx.LEFT | wx.RIGHT, 5),
            (self.roomSizeSlider, 0, wx.EXPAND | wx.BOTTOM | wx.LEFT | wx.RIGHT, 5)
        ])

        self.dampingLabel = wx.StaticText(innerPanel, -1, _("Damping:"))
        self.dampingSlider = wx.Slider(innerPanel, -1, minValue=0, maxValue=100, name=_("Damping"))
        reverbSizer.AddMany([
            (self.dampingLabel, 0, wx.TOP | wx.LEFT | wx.RIGHT, 5),
            (self.dampingSlider, 0, wx.EXPAND | wx.BOTTOM | wx.LEFT | wx.RIGHT, 5)
        ])

        self.wetLevelLabel = wx.StaticText(innerPanel, -1, _("Wet Level:"))
        self.wetLevelSlider = wx.Slider(innerPanel, -1, minValue=0, maxValue=100, name=_("Wet Level"))
        reverbSizer.AddMany([
            (self.wetLevelLabel, 0, wx.TOP | wx.LEFT | wx.RIGHT, 5),
            (self.wetLevelSlider, 0, wx.EXPAND | wx.BOTTOM | wx.LEFT | wx.RIGHT, 5)
        ])

        self.dryLevelLabel = wx.StaticText(innerPanel, -1, _("Dry Level:"))
        self.dryLevelSlider = wx.Slider(innerPanel, -1, minValue=0, maxValue=100, name=_("Dry Level"))
        reverbSizer.AddMany([
            (self.dryLevelLabel, 0, wx.TOP | wx.LEFT | wx.RIGHT, 5),
            (self.dryLevelSlider, 0, wx.EXPAND | wx.BOTTOM | wx.LEFT | wx.RIGHT, 5)
        ])

        self.widthLabel = wx.StaticText(innerPanel, -1, _("Width:"))
        self.widthSlider = wx.Slider(innerPanel, -1, minValue=0, maxValue=100, name=_("Width"))
        reverbSizer.AddMany([
            (self.widthLabel, 0, wx.TOP | wx.LEFT | wx.RIGHT, 5),
            (self.widthSlider, 0, wx.EXPAND | wx.BOTTOM | wx.LEFT | wx.RIGHT, 5)
        ])

        innerSizer.Add(reverbSizer, 0, wx.EXPAND | wx.ALL, 10)
    ...
    def _initialize_at_state(self):
        ...
        self.enableReverbCheckbox.SetValue(unspoken_conf["Reverb"])
        self.roomSizeSlider.SetValue(unspoken_conf["RoomSize"])
        self.dampingSlider.SetValue(unspoken_conf["Damping"])
        self.wetLevelSlider.SetValue(unspoken_conf["WetLevel"])
        self.dryLevelSlider.SetValue(unspoken_conf["DryLevel"])
        self.widthSlider.SetValue(unspoken_conf["Width"])
    ...
    def onEnableReverbCheckboxChanged(self, event):
        ...
        self.roomSizeLabel.Enable(is_checked)
        self.roomSizeSlider.Enable(is_checked)
        self.dampingLabel.Enable(is_checked)
        self.dampingSlider.Enable(is_checked)
        self.wetLevelLabel.Enable(is_checked)
        self.wetLevelSlider.Enable(is_checked)
        self.dryLevelLabel.Enable(is_checked)
        self.dryLevelSlider.Enable(is_checked)
        self.widthLabel.Enable(is_checked)
        self.widthSlider.Enable(is_checked)
